...
Für jeden Prozess stellt STAN eine Bilanzgleichung pro Zeiteinheit auf welche das **Massen-und Energieerhaltungsgesetz** erfüllt. Somit muss die Summe der Inputs der Summe der Outputs und allfälligen Lageränderungen entsprechen. Zum Beispiel: Summe Inputs in den Prozess Tierhaltung = 167 Tonnen Stickstoff pro Jahr = Summe Outputs aus dem Prozess Tierhaltung.

Transferkoeffizienten drücken eine **lineare Beziehung** zwischen In- und Outputflüssen eines Prozesses aus. So könnte man die Transferkoeffizienten des Prozesses Pflanzenbau als Prozentwerte der Inputs darstellen:

-   61% der Stickstoffinputs in den Pflanzenbau gehen in die Tierhaltung (131 Tonnen Stickstoff pro Jahr)

-   5% gehen in pflanzliche Produkte

-   34% sind Auswaschung und Emissionen
